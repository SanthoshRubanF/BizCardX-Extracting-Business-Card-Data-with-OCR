...
with st.sidebar:
  ...
  select= option_menu("Main Menu", ["Home", "Upload & Modifying", "View Data Set", "Delete"])
...
if select == "Home":
  ...
  table3_df = pd.DataFrame(table3, columns=("NAME", "DESIGNATION", "COMPANY_NAME", "CONTACT", "EMAIL", "WEBSITE",
                                          "ADDRESS", "PINCODE", "IMAGE"))
  st.dataframe(table3_df)
